...
INITIAL_MAZE_FILE = "initial_maze.txt"

CELL_COLOR_EMPTY = color_rgb(179, 179, 179)
CELL_COLOR_OBSTACLE = color_rgb(54, 115, 255)
CELL_COLOR_START = color_rgb(255, 126, 0)
CELL_COLOR_END = color_rgb(255, 0, 152)
CELL_COLOR_PATH = color_rgb(111, 242, 127)
...
class MazeApp:
    def __init__(self, maze_file_path, window_width, window_height):
        ...
        self.win = GraphWin("Maze Game", width=window_width, height=window_height)
