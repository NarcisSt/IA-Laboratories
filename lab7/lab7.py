...
TRAINING_FILE_EXPECTED_NUM_LINES = 2
...
class NNInfo:
    ...
    def parse_file(self, file_name):
        with open(file_name, "r") as file_in:
            ...
            max_error = float(input("\nPlease enter the maximum error: "))
...
if __name__ == "__main__":
    ...
    nn_info = NNInfo(TRAINING_FILE_INFO_PATH)
    ...
    nn.train(nn_info, epochs_count)

    while True:
        print("Enter bellow the values you want to test:")
        line = input()
